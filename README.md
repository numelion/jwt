...
- PHP 8.0+
- OpenSSL Extension
- [lcobucci/jwt 5.0.x](https://github.com/lcobucci/jwt/tree/5.0.x)
...
class ExampleController extends \yii\rest\Controller
{
    ...
    public function behaviors()
    {
        ...
        $behaviors['authenticator'] = [
            'class' => \numelion\jwt\JwtHttpBearerAuth::class,
        ];
...
Use the builder to create a new JWT/JWS tokens:
...
'components' => [
    'jwt' => [
        ...
        'key'   => 'secret',
        'jwtValidationData' => [
            'class' => \numelion\jwt\JwtValidationData::class,
             // configure leeway 
            'leeway' => 20,
        ],
    ],
...
1. Create Yii2 application
    ...
    ```shell
    composer create-project --prefer-dist --stability=dev yiisoft/yii2-app-basic jwt-test
    ```
...
4. Create JwtValidationData class. Where you have to configure ValidationData informing all claims you want to validate the token.
    ...
    class JwtValidationData extends \numelion\jwt\JwtValidationData
    {
...
6. Create controller
    ...
    use numelion\jwt\Jwt;
    use numelion\jwt\JwtHttpBearerAuth;
    use Yii;
